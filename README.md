...
| `notify-ai-pr.yml` | `workflow_call` | On bot PR open | Posts Slack notification to #github-automation when claude[bot] opens a PR |
...
| `pr-issue-linker.yml` | `workflow_call` | On PR open/close | Auto-links PRs to referenced issues via Development sidebar |
